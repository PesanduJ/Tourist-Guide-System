...
public class Restaurant {
    ...
    @JoinColumn(name= "rl_fk", referencedColumnName = "id")
    ...
    @OneToMany(targetEntity = Tables.class, cascade = CascadeType.ALL )             //defining table relationship
    @JoinColumn(name= "rt_fk", referencedColumnName = "id")
